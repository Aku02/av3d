...
import hydra
import numpy as np
from av3d.lib.smpl.body_models import SMPL
...
class SMPLServer(torch.nn.Module):
    ...
    def __init__(self, gender='neutral', betas=None, v_template=None):
        ...
        self.smpl = SMPL(model_path=hydra.utils.to_absolute_path('av3d/lib/smpl/smpl_model'),
                         gender=gender,
                         batch_size=1,
                         use_hands=False,
        ...
        self.global_orient = output['global_orient']
    ...
    def forward(self, smpl_params, absolute=False):
        ...
        output['global_orient'] = smpl_output.global_orient
