...
class NerfModel(nn.Module):
    ...
    def __init__(
        ...
        stop_level_grad: bool = False,  # If True, don't backprop across levels')
...
def volumetric_rendering(rgb, cano_feat, density, t_vals, dirs, color_bkgd):
    ...
    comp_feat = (weights[..., None] * cano_feat).sum(dim=-2)
    ...
    return comp_rgb, comp_feat, depth, acc, weights
