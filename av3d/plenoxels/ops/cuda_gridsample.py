# src https://github.com/AliaksandrSiarohin/cuda-gridsample-grad2
...
gridsample_grad2 = load(name='gridsample_grad2', sources=[f'{cuda_dir}/gridsample_cuda.cpp', f'{cuda_dir}/gridsample_cuda.cu'], verbose=True)
